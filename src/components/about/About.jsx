  ...
  return (
    <div className='about' id='about'>
      ...
      <div className='wrapper'>
        ...
        <div className='description'>I'm a self-taught Web Developer with a background in 3D modeling and Game Art. The enormous potential of software and my passion for problem-solving have led me into pursuing a coding career. During my past experience, I’ve realized how important are tools that automate mundane tasks and help people unleash their creativity. I soon realized that creating those tools would have given me a great sense of fulfillment.
